...
export default function ADERightDock({ projectPath, activeWorkspaceId, pinned = true, onTogglePin, onClose }: Props) {
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-h-0 overflow-hidden">
        {activeTab === "chat" && <QueenBeeChat docked onToggleDock={() => {}} />}
        {activeTab === "history" && (
